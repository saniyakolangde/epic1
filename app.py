...
# ]),
    html.Div([
        html.H4("Common places humanitarian migrants come from", style={'textAlign': 'center', 'color': 'purple', 'marginBottom': '12px', 'marginTop': '13px'}),
        html.Img(src=f'data:image/png;base64,{image_base64}', style={'width': '40%', 'height': 'auto', 'display': 'block', 'margin': '0 auto'})
    ], style={
        'display': 'flex',
    ...
    html.Div([
        html.H6(
            ...
            style={'textAlign': 'center', 'color': 'purple', 'fontSize': 16}
        ),
        html.H6(
    ...
    #                 'Egypt', 'Papua New Guinea', 'Indonesia']],
    #         value='All'
    #     )], style={'textAlign': 'center', 'width': '40%', 'marginRight': '20px'}),  # Dropdown width and margin to separate from the graph
